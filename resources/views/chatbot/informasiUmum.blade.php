...
@section('title', 'Halaman Kelola Kebijakan Chatbot')
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <h2>EDITING CHATBOT <br> Kebijakan</h2>
                                            ...
                                            <form role="form">
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan Nama Intent">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputPassword1">Description 'Optional'</label>
                                                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Berikan Deskripsi ('Opsional')">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputPassword1">Contoh Jawaban User</label>
                                                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Masukan contoh kemungkinan jawaban">
                                                    </div>
                                                </div>
                                                <!-- /.card-body -->
